function RenderLoadingBar_Standard(_graphics, _width,_height, _total, _current, _loadingscreen) 
{
	...
	if (_loadingscreen)
	{
		...
		jsDrawCenteredText(_graphics, _width / 2, (_height *0.70), "rgba(151,153,154,255)", "Choose Ahok as your Governor.");
		jsDrawCenteredText(_graphics, _width / 2, (_height *0.73), "rgba(141,143,144,155)", "                         Jacobian");
	} 
}
